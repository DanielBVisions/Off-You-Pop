...
JPEG snapshot (falling back to a lower resolution automatically if a
particular frame would otherwise be too large to upload), and sends
everything to the backend to create a `SignoffRecord`.
