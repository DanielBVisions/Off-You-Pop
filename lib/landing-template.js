...
const PAGE_STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  /* Full-bleed: break out of .wrap's max-width so the frame genuinely
     ...
     than sitting in a small card inside the page's text column. */
  .carousel { width:100vw; position:relative; left:50%; transform:translateX(-50%); margin-bottom:28px; }
  .carousel-viewport { position:relative; background:#1e1e1e; overflow:hidden; height:78vh; min-height:340px; }
  .carousel-slide { display:none; }
  .carousel-slide.is-active { display:flex; position:absolute; inset:0; align-items:center; justify-content:center; }
