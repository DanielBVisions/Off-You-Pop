...
const PAGE_STYLES = `
  ...
  * { box-sizing: border-box; }
  ...
  /* The stage: a full-bleed, near-full-viewport-height dark canvas right
     below the bar, modeled on Figma's own Present mode. The frame itself
     is sized by width alone (no object-fit/fixed aspect box — see the
     earlier letterboxing bug) and vertically centered within the stage
     via flex if it's shorter than the stage's min-height. */
